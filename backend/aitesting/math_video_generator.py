...
class MathVideoGenerator:
    ...
    def generate_manim_code(self, math_topic, difficulty="intermediate", duration=30):
        ...
        11. IMPORTANT: When transforming equations, create separate MathTex objects for each step
        12. IMPORTANT: Use Transform() or ReplacementTransform() instead of TransformMatchingTex for better compatibility
        13. AVOID using multiple strings in a single MathTex constructor
    ...
    def create_video(self, math_topic, difficulty="intermediate", duration=30, quality="medium_quality"):
        ...
        try:
            ...
            cmd = [
                ...
                "-pql" if quality_map.get(quality, "m") == "l" else
                "-pqm" if quality_map.get(quality, "m") == "m" else
                "-pqh"
            ]
